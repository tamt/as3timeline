package timeline.core.elements
{
	...
	public class Element
	{
		 ...
		 */
		public function getPersistentData(name : String) : *
		{
			if (_persistentData) return _persistentData[name];
			return null;
		}
		...
		{
			return Boolean(_persistentData && _persistentData[name]);
		}
		 ...
		 */
		public function setPersistentData(name : String, type : String, value : *) : void
		{
			if (EnumsValidator.validate(EnumPersistentDataType, type))
			{
				_persistentData[name] = value;
			}
		}
		...
		{
			this._transformPoint = transformationPoint;
		}
